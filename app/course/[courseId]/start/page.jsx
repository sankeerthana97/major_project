        ...
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                <div className='w-72 hidden md:block h-[calc(100vh-65px)] border-r shadow-sm overflow-y-auto'>
                    <h2 className='font-medium text-lg bg-blue-600 p-4 text-white'>
                    ...
                    <div>
                        {course?.courseOutput?.course?.chapters.map((chapter, index) => (
                            <div 
                                ...
                                ${selectedChapter?.name === chapter?.name ? 'bg-violet-100' : ''}`}
                                onClick={() => {
                    ...
                    <div className="mt-8">
                        {!isLastChapter ? (
                            <Button 
                                ...
                                className="w-full bg-blue-600 hover:bg-violet-700 text-white"
                            >
                                Next Chapter
                            </Button>
                        ) : (
